...
export const Hero = ({
  ...
  return (
    <section
      className='relative grid h-[100vh] items-center justify-center bg-cover bg-center bg-no-repeat'
    ...
    >
      ...
      <div className='relative z-10 mt-10 text-center'>
        ...
        <div className='text-white'>
          <p className='text-lg'>
            "Interior design is not just about creating beautiful spaces; it’s
            about designing environments that inspire and elevate the human
            experience."
          </p>
        </div>
