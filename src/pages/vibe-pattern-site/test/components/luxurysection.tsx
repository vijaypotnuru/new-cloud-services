...
export const LuxurySection = () => {
  ...
  return (
    <section className='bg-mediumBlack' id='next-section'>
        ...
        <div className='flex flex-col items-center justify-between md:flex-row'>
          ...
          >
            ...
            <p className='font-serif text-sm font-normal leading-[26px] text-gray-400 md:text-sm lg:text-base xl:text-base'>
              Our mission is to create stunning interiors that reflect your
              unique style and enhance your living experience. We blend
              functionality with elegance, ensuring every space is both
              beautiful and practical.
            </p>
            <p className='mt-5 font-serif text-sm font-normal leading-[26px] text-gray-400 sm:text-base'>
              From concept to completion, our team of skilled designers works
              closely with you to bring your vision to life. We specialize in
              creating harmonious environments that inspire and rejuvenate.
            </p>
            ...
            <button className='mt-[30px] bg-[#C19D68] px-10 py-4 text-white'>
              DISCOVER MORE
            </button>
          </div>
        </div>
