        ...
        <CardFooter>
          <Dialog open={isEditingProject} onOpenChange={setIsEditingProject}>
            <DialogTrigger asChild>
              <Button className='bg-[#53278d] text-[#e4dee2]' onClick={() => setIsEditingProject(true)}>
            ...
            <DialogContent className='sm:max-w-[425px] bg-[#e4dee2]'>
              ...
              <form
                onSubmit={handleSubmitProject(onSubmitProjectEdit)}
                className='space-y-4'
              >
                <FoamField
                  label='Project Name'
                  ...
                  icon={Package}
                >
                  <Input {...registerProject('projectName')} />
                </FoamField>
                <FoamField
                  label='Location'
                  error={projectErrors.location?.message}
                  icon={MapPin}
                >
                  <Input {...registerProject('location')} />
                </FoamField>
                <FoamField
                  label='Budget'
                  error={projectErrors.budget?.message}
                  icon={IndianRupee}
                >
                  <Input
                    type='number'
                    {...registerProject('budget', { valueAsNumber: true })}
                  />
                </FoamField>
                <FoamField
                  label='Material'
                  error={projectErrors.material?.message}
                  icon={Package}
                >
                  <Input {...registerProject('material')} />
                </FoamField>
                <FoamField
                  label='Description'
                  error={projectErrors.projectDescription?.message}
                  icon={Package}
                >
                  <Textarea {...registerProject('projectDescription')} />
                </FoamField>
      ...
      <Card className='bg-[#e4dee2]'>
                  ...
                  <div key={milestone.milestone_id} className='mb-8 flex'>
                    <div className='mr-4 flex flex-col items-center'>
                      ...
                      {index < projectDetails.milestones.length - 1 && (
                        <div className='my-2 h-full w-px bg-gray-300'></div>
                      )}
                    </div>
        ...
        <CardFooter>
          <Dialog open={isAddingMilestone} onOpenChange={setIsAddingMilestone}>
            <DialogTrigger asChild>
              <Button className='bg-[#53278d] text-[#e4dee2]' onClick={() => setIsAddingMilestone(true)}>
                Add New Milestonce
              </Button>
            </DialogTrigger>
            <DialogContent className='bg-[#e4dee2]'>
              ...
              >
                ...
                <Button className='bg-[#53278d] text-[#e4dee2]' type='submit' loading={isSubmitting}>
                  Add Milestone
                </Button>
              </form>
              {isSubmitting && (
