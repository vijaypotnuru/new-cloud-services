  ...
  return (
    ...
    >
      <TooltipProvider delayDuration={0}>
        ...
        <div className="mt-auto grid gap-1 group-[[data-collapsed=true]]:justify-center group-[[data-collapsed=true]]:px-2">
          {isCollapsed ? (
            ...
            <Button
              variant="ghost" 
              size="sm"
              className="h-12 justify-start self-end rounded-none px-6"
              onClick={onLogout}
            >
